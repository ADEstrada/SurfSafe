...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.getElementById('forecastContainer') && document.getElementById('forecastCardTemplate')) {
...
// HOMEPAGE HAZARD MAP MINI PREVIEW
function initHomepageMapPreview() {
    ...
    fetch('get_active_hazards.php')
        ...
        .catch(error => {
            console.error("Error loading homepage hazard map:", error);
        });
}
    ...
    fetch('get_active_hazards.php')
        ...
        .then(data => {
            ...
            data.hazards.forEach(hazard => {
                ...
                if (hazard.status &&
                    hazard.status.toLowerCase() === 'dangerous') {
                    badgeColor = 'danger';
                }
        ...
        .catch(error => {
            console.error("Hazard map loading error:", error);
        });
}