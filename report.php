        ...
        <main>
            ...
            <section class="report-cta-banner position-relative">
                <div class="container text-center">
                    ...
                    <h2 class="report-cta-message">Help the Bagasbas community by reporting hazards like rip currents, jellyfish, or debris.</h2>

                    <div class="report-action-area">
                        <button class="btn-report-submit" onclick="handleReportSubmission()">Submit Live Reports</button>
                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Submit New Hazard Report</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id="hazardForm">
                        <div class="modal-body">
                            <label class="form-label fw-bold">Click on the map to set hazard location:</label>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="hazard_type" required>
                                        ...
                                        <option value="Strong Waves">Strong Waves</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" name="description" rows="3" placeholder="Describe the hazard..." required></textarea>
                                </div>
                            </div>
                        </div>
